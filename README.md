...
4. What are IDE’s for C# development? ( Naib )

> Visual Studio 2017

5. C# - daki Kamentariya Tiplərini İzah Edin ( Vilayet )
...
29. Niyə massiflərin ölçüsü sabit olmalıdır? ( Zamin )
...
73. List out the pre defined attributes in C#? ( Nərmin )
