...
Zamin Hesenov 1999 ci il yaranib.Anders Hejlberg terefinden inkisaf eletdirlib.Hal hazirde web ve ya desktop lahiyeler yazmaqda istifade ollunur.Obeykt yonumlu proglasdirma dilinden istifade olunur
...
> mammadov002 :
> C# 2000-ci ildə "Andres Heilsberg" - tərəfindən Microsoftda Javaya rəqib olaraq yaradılan müasir Obyekt Yönümlü Programlaşdırma Dilidir. C# Microsoftun Java üzərində dəyişiklik etməsini istəmədiyi üçün yaradıldı. C# ilk yaradıldığı gündən bəri sürətli bir şəkildə inkişaf etdi və hal-hazırda dünyanın ən populyar Programlaşdırma Dillərindən biridir. C#-ın yaradilmasında C və C++ - dan istifadə edilib və buna görədə C# , C və C++ - in hibrididir. C# həmçinin Web-Applications yaratmaq üçün istifade olunur , amma özəlliklə mobil tətbiqlər inkişaf etdirmək üçündə get-gedə daha populyar hala gəlmişdir.Xamarin kimi Cross-Platform alətlər(tools) C# - da yazılan tətbiqləri demək olar ki bütün mobil cihazlarda istifadə olunmasını təmin edir.
