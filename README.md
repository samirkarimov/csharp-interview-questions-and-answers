...
65. C# compilerinin adı nədir?
C# compilerinin adı CSC-dir. Misal üçün Code.cs faylının executable-ını yaratmaq üçün " CSD Code.cs " kommandı lazımdır ki, bu Code.exe file-ını yaradacaqdır.
...
69. C#-da iki string-i birləşdirmək üçün hansı string metodundan istifadə olunur? @beshirazizov
>C#-da iki string-i birləşdirməyin müxtəlif yolları vardır. String.Concat(), String.Join(), StringBuilder.Append() və ya sadəcə "string"+"string". Əlbəttə, bu metodlar arasında müəyyən fərqlər mövcuddur ki, bu da müxtəlif case-lərdə sürət fərqinə səbəb ola bilir. Əgər stringlər sabitdirlərsə bu zaman onları birləşdirmək üçün ən əlverişli yol "string"+"string" hesab olunur. IL kodunun analizi göstərir ki compiler "string"+"string" line-ını avtomatik olaraq "stringstring"-ə çevirir. Amma dəyişkən stringlərdə hal başqadır. Bir çox mənbələrdə String.Concat() methodunun dəyişkən stringlər üçün digərlərindən daha sürətli olduğu deyilir. Lakin dəyişkən stringlərin sayı 1000-ə yaxınlaşdıqda String.Concat() metodu performansda nəzərəçarpan yavaşlamaya səbəb olur ki, bu halda StringBuilder.Append() metodundan istifadə mələhət görülür.
...
78. Obyekt nədir?
> Yuxarıda class-lar barədə məlumat vermişdik. Obyekt sadə dildə desək class-a görə formalaşmış yaddaş blokudur. Bir proqramın içində eyni class-dan bir çox obyekt yrada bilərik.
